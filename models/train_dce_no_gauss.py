...
model = DCEVAE(input_dim=input_dim, latent_dim=latent_dim, use_gaussian_weighting = False).to(device)
model.train
...
for ep in range(1, epochs + 1):
    ...
    for x, y in loader:
        ...
        loss = recon_loss + kl_loss + ce_loss
...
SAVE_PATH = os.path.join(
    ...
    f"dce_vae_latent{latent_dim}_no_gauss_new_10.pt"
)
